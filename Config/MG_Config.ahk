...
MG_IsTarget1() {
	global
	return ((MG_Exe="iexplore.exe") || (MG_Exe="msedge.exe") || (MG_Exe="chrome.exe") || (MG_Exe="firefox.exe") || (MG_Exe="browser.exe"))
}

MG_IsTarget2() {
	global
	return (MG_IsTarget1() && ((MG_Exe="browser.exe")))
}
...
MG_IsTarget4() {
	global
	return (MG_IsTarget3() && ((MG_TreeListHitTest())))
}

MG_IsTarget5() {
	global
	return ((MG_Exe="GitHubDesktop.exe"))
}
